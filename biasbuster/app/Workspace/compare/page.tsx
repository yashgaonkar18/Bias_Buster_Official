    ...
    <div className="w-full">
      <div className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Model Variant Comparison</h1>
            <p className="text-sm text-gray-500">Benchmark accuracy and fairness across all model versions.</p>
          </div>
          <button
            onClick={fetchComparison}
            className="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded font-semibold hover:bg-gray-50 flex items-center gap-2 transition-all active:scale-95 shadow-sm"
          >
            <BarChart3 className="w-4 h-4" /> Refresh Registry
          </button>
        </div>
      </div>

      <div className="mt-8 border-t-4 border-gray-200 bg-gray-50">
          ...
          {activeResponseTab === "body" && (
            comparisonData ? (
              ...
              <div className="flex flex-col items-center justify-center p-12 border border-dashed rounded-lg bg-gray-50">
                ...
                <p className="text-gray-500 mb-4">Registry data not yet fetched for this workspace.</p>
                <button
                  onClick={fetchComparison}
                  className="px-6 py-2 bg-orange-500 text-white rounded font-bold hover:bg-orange-600 shadow transition-all active:scale-95"
                >
