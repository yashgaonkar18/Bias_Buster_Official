    ...
    return (
      <div className="max-w-4xl space-y-6 animate-in fade-in duration-500">
        <div className="border-b pb-4">
          <h3 className="font-phase flex items-center gap-2 text-gray-800 text-lg">
            <Settings className="w-5 h-5 text-indigo-500" /> Fairness-Aware Optimization
          </h3>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div
              className={`p-4 border rounded-lg cursor-pointer transition-all ${optMethod === "gridsearch" ? "border-indigo-500 bg-indigo-50 ring-1 ring-indigo-500" : "hover:bg-gray-50 bg-white border-gray-200"}`}
            ...
            <div
              className={`p-4 border rounded-lg cursor-pointer transition-all ${optMethod === "optuna" ? "border-indigo-500 bg-indigo-50 ring-1 ring-indigo-500" : "hover:bg-gray-50 bg-white border-gray-200"}`}
        ...
        <div className="flex items-center gap-4 pt-6 border-t mt-8">
          <button
            ...
            className="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-bold shadow transition-all active:scale-95 cursor-pointer text-sm flex items-center gap-2"
          >
        ...
        <div className="flex items-center justify-between pt-6">
          <div className="flex gap-3">
            <button
              ...
              className="px-4 py-2 bg-white border border-indigo-200 text-indigo-700 rounded-lg text-sm font-semibold hover:bg-indigo-50 flex items-center gap-2 shadow-sm transition-all active:scale-95 cursor-pointer"
            >
              <Download className="w-4 h-4 text-indigo-600" /> Download Optimized Model
            </button>
            <button
              onClick={async () => {
            ...
            >
              <BarChart3 className="w-4 h-4 text-gray-500" /> Compare All Models
            </button>
          </div>
          <button
            onClick={() => alert("Model promoted to Model Registry and Production-ready staging.")}
            className="px-8 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg flex items-center gap-2 shadow-md transition-all active:scale-95 cursor-pointer font-semibold text-sm"
          >
            <CheckCircle className="w-5 h-5" /> Approve for Production
          </button>
        </div>
      </div>
    );
